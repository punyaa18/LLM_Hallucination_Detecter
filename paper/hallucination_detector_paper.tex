...
\and
\IEEEauthorblockN{Dr. Apeksha Sakhare}
\IEEEauthorblockA{\textit{Faculty in Department of Computer Science}\\
\textit{G H Raisoni College of Engineering, Nagpur}\\
Email: apeksha.sakhare@raisoni.net}
}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{figures/pipeline.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{figures/domain_accuracy.png}}
