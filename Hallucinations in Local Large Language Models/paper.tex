...
Fig.~\ref{fig:featurearch} shows the end-to-end feature pipeline used in this work, from prompt generation and local model execution to scoring, validation assets, and paper outputs.

\begin{figure}[!t]
\centering
\includegraphics[width=0.98\linewidth]{figures/feature_architecture.png}
\caption{Feature architecture of the local hallucination evaluation framework.}
